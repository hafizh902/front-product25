...
import { Product, ProductPayload } from "@/service/products";
...
export default function ProductPage() {
 ...
 const handleEditSubmit = async (e: React.FormEvent) => {
   e.preventDefault();
   if (!validateForm() || !selectedProduct || !selectedProduct.id) return;
   setIsSubmitting(true);
   try {
       ...
       <DialogContent>
         ...
         {detailProduct && (
           <div className="space-y-2">
             ...
             <p>
               <strong>Harga:</strong> Rp {(detailProduct.price || 0).toLocaleString()}
             </p>
             <p>
